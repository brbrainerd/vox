...
- `GITHUB_SHA`
- `GITHUB_TOKEN`
- `GITLAB_TOKEN` *(DEPRECATED — use FORGE_TOKEN)*
...
- `VOX_REPOSITORY_ROOT`
- `VOX_REPO_ROOT`
- `VOX_RESEARCH_FREE_TIER`
- `VOX_RESEARCH_FREE_TIER_MODELS`
