---
title: Mobile architecture and migration plan — React Native + Expo + uniffi for Vox (2026)
status: draft
date: 2026-05-27
authors: [vox-team]
related:
...
| Mobile GUI | [crates/vox-codegen/src/codegen_ts/mobile_emit.rs](crates/vox-codegen/src/codegen_ts/mobile_emit.rs) emits `@tauri-apps/api/event` | emits `@vox/runtime` calls (adapter-shaped) |
| Mobile app of record | [apps/vox-mental-tracker](apps/vox-mental-tracker) on Capacitor | on Expo (managed workflow) |
...
- [ADR 037 (2026-05-11)](docs/src/architecture/) said Tauri = desktop + Android + iOS canonical. The bake-off (2026-05-27) confirmed the Windows-host build hangs; the [Tauri team itself](https://v2.tauri.app/blog/tauri-20/) calls mobile not-yet-first-class. This plan scopes ADR 037 down to desktop.
...
| [apps/vox-mental-tracker](apps/vox-mental-tracker) | exists | Migrate Capacitor → Expo; replace sherpa plugin |
| [vox-sherpa-transcribe](apps/vox-mental-tracker/plugins/vox-sherpa-transcribe) | exists (Capacitor) | Rewrite as Expo Module wrapping Candle Whisper via uniffi |
...
- [ ] Update [Codegen SSOT Unification 2026](codegen-ssot-unification-design-2026.md) to absorb the RN lowering as an addition to its "ship @vox/runtime npm" phase.
...
- [ ] Migrate [apps/vox-mental-tracker](apps/vox-mental-tracker) to RN+Expo scaffolding. Capacitor refs deleted.
...
- [ ] Update [docs/how-to/build-android.md](docs/how-to/build-android.md) → RN+Expo workflow.
- [ ] Create [docs/how-to/build-ios.md](docs/how-to/build-ios.md) (new; Tauri-mobile never had a working version).
- [ ] Update [docs/user/privacy.md](docs/user/privacy.md) — on-device transcription claim now real.
...
| Privacy-first storage | 2 | All on-device; no remote backend; aligns with current [privacy.md](apps/vox-mental-tracker/docs/user/privacy.md) |
...
- [Codegen SSOT Unification 2026](codegen-ssot-unification-design-2026.md) — this plan absorbs into Phase 4 of that work.
