...
- [`research-index.md`](research-index.md) — hand-curated architecture and research entry point (Starlight sidebar replaces the retired auto-generated architecture index).
