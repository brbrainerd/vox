...
| [`vox-dei-shim`](../../../crates/vox-dei-shim/) | DEI research pipeline and model-selection sub-systems (extracted from vox-orchestrator as A-12 wedge crate). Contains SCIENTIA research orchestrator, claim extraction, verification, persistence, BroadcastEmitter, ScientiaMeshSubscriber. |
| [`vox-orchestrator`](../../../crates/vox-orchestrator/) | Multi-agent file-affinity router: Orchestrator struct + all impl blocks, task dispatch, planning, services, models, config, runtime glue. Research pipeline (dei_shim) extracted to vox-dei-shim. queue/lock/oplog in vox-orchestrator-queue, MCP in vox-orchestrator-mcp. Extraction plan: see [2026-05-15-orchestrator-tier-d-plan.md](./2026-05-15-orchestrator-tier-d-plan.md). |
