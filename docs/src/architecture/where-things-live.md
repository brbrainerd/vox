...
| Vox Console UI surface (terminal, input editor, discovery rail, agent strip) | [`crates/vox-gui/ui/src/components/surfaces/Console/`](../../../crates/vox-gui/ui/src/components/surfaces/Console/); registered as `console` (`live_backend`) in [`contracts/gui/surface-registry.v1.yaml`](../../../contracts/gui/surface-registry.v1.yaml). |
