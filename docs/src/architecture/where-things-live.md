...
| Graphify corpus registry + freshness | [`contracts/retrieval/graphify-corpora.v1.yaml`](../../../contracts/retrieval/graphify-corpora.v1.yaml) | Loader + `assess_corpus_status` in [`vox-config`](../../../crates/vox-config/) (`graphify`); read-only CLI `vox graphify status` in [`vox-cli`](../../../crates/vox-cli/) (`commands/graphify/`). Tier D cache target: `.vox/cache/graphify/<corpus_id>/`. Legacy graphs may still live under `graphify-out/` (see [`graphify-integration-research-2026-06-16.md`](./graphify-integration-research-2026-06-16.md)). |
