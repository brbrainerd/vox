...
---
<!-- Synced from the repository-root CHANGELOG.md, which is the SSOT (git-cliff writes it on tag). Do not edit this file directly; edit CHANGELOG.md. Root-relative links are rebased to this page's depth. -->
# Changelog
