...
|---|---|---|---|---|---|
| Eval sandbox | eval.voxlang.org | vox-eval.compose.yml | ghcr.io/brbrainerd/vox-eval-sandbox (personal namespace — org free tier can't make container packages public) | COOLIFY_APP_UUID | https://eval.voxlang.org/health |
