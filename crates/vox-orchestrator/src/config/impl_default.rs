...
impl Default for OrchestratorConfig {
    fn default() -> Self {
        Self {
            ...
            populi_remote_execute_receiver_agent: None,
            ...
            parallel_context_enabled: default_parallel_context_enabled(),
            context_gather_timeout_secs: default_context_gather_timeout_secs(),
