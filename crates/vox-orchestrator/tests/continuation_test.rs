...
fn test_continuation_engine() {
    ...
    let prompt1 = engine.generate_continuation(
        agent_id,
    ...
    let prompt2 = cooled_engine.generate_continuation(
        AgentId(2),
        ContinuationStrategy::Continue,
        1,
        0,
    ...
    let prompt3 = cooled_engine.generate_continuation(
        AgentId(2),
        ContinuationStrategy::Continue,
        1,
        0,
    ...
    let prompt4 = cooled_engine.generate_continuation(
        AgentId(2),
        ContinuationStrategy::Continue,
        1,
        0,
