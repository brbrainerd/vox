...
//! land in [`vox_compiler::react_bridge`] + Web IR lower/validate before growing this adapter.
//!
...
fn emit_component_pattern(pattern: &vox_compiler::ast::pattern::Pattern) -> String {
    match pattern {
