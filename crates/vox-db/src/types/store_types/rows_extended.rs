...
pub struct SkillExecutionRow {
    ...
    pub session_id: Option<crate::types::ids::DbSessionId>,
    /// Workflow execution identifier, if any.
    pub workflow_id: Option<String>,
    /// Agent that ran the skill.
    pub agent_id: Option<crate::types::ids::DbAgentId>,
    /// `"ok"` | `"error"` | `"timeout"`.
    pub status: String,
...
pub struct QuestionSessionRow {
    pub id: i64,
    pub session_id: crate::types::ids::DbSessionId,
    pub repository_id: String,
    pub task_id: Option<crate::types::ids::DbTaskId>,
...
pub struct AgentEventRow {
    pub id: i64,
    pub agent_id: crate::types::ids::DbAgentId,
...
pub struct PlanSessionRow {
    pub plan_session_id: crate::types::ids::DbPlanSessionId,
