...
/**
 * The groma — a Roman surveyor's instrument — rendered as an equal-armed cross
 * within a ring, with cardinal arrowheads. The Vox Axis app mark. Inherits
 * color via `currentColor`; defaults to the imperial-gold accent (`--brass`).
 */
export function AxisMark({ size = 24, className }: AxisMarkProps) {
  return (
    ...
    >
      ...
      <path
        d="M50 6 l6 10 h-12 z M50 94 l6 -10 h-12 z M6 50 l10 6 v-12 z M94 50 l-10 6 v-12 z"
        fill="currentColor"
      />
    </svg>
  );
