  ...
  return (
    <div ref={setNodeRef} style={style} data-widget-id={widget.id}>
      {customizeMode && (
        <button
          type="button"
          className="absolute left-2 top-2 z-10 cursor-grab rounded border border-white/10 bg-zinc-900/80 px-1.5 py-0.5 font-mono text-[10px] text-zinc-400 active:cursor-grabbing"
      ...
      {customizeMode && (
        <button
          type="button"
          className="absolute bottom-1 right-1 z-10 h-4 w-4 cursor-se-resize rounded-sm border border-white/20 bg-zinc-900/90"
